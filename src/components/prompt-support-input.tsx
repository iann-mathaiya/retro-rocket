...
export default function PromptSupportInput() {
    return (
        <div className="sm:mt-8 w-full max-w-2xl fixed bottom-0 sm:relative p-4">
            <form method="POST" action={actions.support.createTicket} className="flex flex-col gap-0 bg-gray-300/50 border border-gray-400/40 rounded-2xl backdrop-blur-xl">
