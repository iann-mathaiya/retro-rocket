...
export default function FloatingMobileNavigation() {
  return (
    <Drawer.Root>
      <Drawer.Trigger className='p-3 block fixed bottom-4 right-4 bg-gray-200 shadow-lg rounded-full'>
      ...
      <Drawer.Portal>
        <Drawer.Overlay className="flex justify-center fixed inset-0 bg-black/40" />
        <Drawer.Content className="w-full sm:max-w-sm h-fit fixed bottom-0 -translate-x-1/2 left-1/2 outline-none">
          <div className='p-4 m-4 bg-white rounded-3xl'>
            ...
            <div className='mt-4 space-y-3'>
              <button type="button" className='w-full p-3 flex items-center gap-3 text-lg text-orange-600 bg-orange-200/40 hover:bg-orange-600 hover:cursor-pointer rounded-xl transition-all duration-500 ease-in-out'>
              ...
              <a href='/' className='w-full p-3 flex items-center gap-3 text-lg text-gray-900 bg-gray-100 hover:bg-orange-600 hover:cursor-pointer rounded-xl transition-all duration-500 ease-in-out'>
              ...
              <a href='/blog' className='w-full p-3 flex items-center gap-3 text-lg text-gray-900 bg-gray-100 hover:bg-orange-600 hover:cursor-pointer rounded-xl transition-all duration-500 ease-in-out'>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-gray-500">
              ...
              <a href='/about' className='w-full p-3 flex items-center gap-3 text-lg text-gray-900 bg-gray-100 hover:bg-orange-600 hover:cursor-pointer rounded-xl transition-all duration-500 ease-in-out'>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-gray-500">
