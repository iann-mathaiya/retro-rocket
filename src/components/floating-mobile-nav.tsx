  ...
  return (
    <Drawer.Root>
      ...
      <Drawer.Portal>
        ...
        <Drawer.Content className="block sm:hidden p-4 bg-white h-fit fixed bottom-0 left-0 right-0 outline-none rounded-t-3xl">
          ...
          <div className='mt-4 space-y-3'>
            ...
            <a href='/products' className='w-full p-3 flex items-center gap-3 text-lg text-gray-900 bg-gray-100 hover:bg-orange-600 hover:cursor-pointer rounded-xl transition-all duration-500 ease-in-out'>
